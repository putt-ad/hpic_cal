...
# (https://github.com/putt-ad/micro_ecology_shiny_sim/blob/master/calibration_style_guide)
# df <- read.csv("formatted_chromeleon_output_file.csv")
#####

hpic_cal <- function(df) {
  if (!is.data.frame (df)) 
